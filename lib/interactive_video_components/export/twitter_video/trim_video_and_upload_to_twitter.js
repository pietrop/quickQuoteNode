...
var trim_and_upload_to_twitter = function (src, input, duration, outName, status){
...
module.exports = {
    trim_and_upload_to_twitter : function(src, input, duration, outName, status){
    return trim_and_upload_to_twitter(src, input, duration, outName, status);
  }//,
};
