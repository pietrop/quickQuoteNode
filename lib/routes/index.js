...
var outName= "twit_export.mp4";
// TWEET ON BEHALF OF USER
//by defining user specific credentials.
// var credentials = {
//   consumer_key:     config.twitter.consumer_key,
//   consumer_secret:  config.twitter.consumer_secret,
//   token:            req.user.token,//config.twitter.token,
//   token_secret:     req.user.tokenSecret//req.user._id.tokenSecret//config.twitter.token_secret
// };
...
twUploader.trim_and_upload_to_twitter(src, input, dur, outName, text);

  //pass twitter user tokens to twitter upload module
